...
public class CharSequenceUtil implements CharPool {
   ...
   *
   * @param ch 要获取长度的 CharSequence, 可能为 null
   ...
   *
   * <ul>
   *   <li>{@code CharSequenceUtil.isAllEmpty() // true}
   *   <li>{@code CharSequenceUtil.isAllEmpty("", null) // true}
   *   <li>{@code CharSequenceUtil.isAllEmpty("123", "") // false}
   *   <li>{@code CharSequenceUtil.isAllEmpty("123", "abc") // false}
   ...
   *
   * <ul>
   *   <li>{@code CharSequenceUtil.hasEmpty() // true}
   *   <li>{@code CharSequenceUtil.hasEmpty("", null) // true}
   *   <li>{@code CharSequenceUtil.hasEmpty("123", "") // true}
   *   <li>{@code CharSequenceUtil.hasEmpty("123", "abc") // false}
   ...
   *
   * <ul>
   *   <li>{@code CharSequenceUtil.isAllNotEmpty() // false}
   *   <li>{@code CharSequenceUtil.isAllNotEmpty("", null) // false}
   *   <li>{@code CharSequenceUtil.isAllNotEmpty("123", "") // false}
   *   <li>{@code CharSequenceUtil.isAllNotEmpty("123", "abc") // true}
   ...
   *
   * @param cs1 CharSequence 1, 可能为 null
   * @param cs2 CharSequence 2, 可能为 null
   * @return 是否相等
   */
  ...
  public static boolean equals(
      final @Nullable CharSequence cs1, final @Nullable CharSequence cs2, boolean ignoreCase) {
  ...
  public static boolean equalsIgnoreCase(
      final @Nullable CharSequence cs1, final @Nullable CharSequence cs2) {
    if (cs1 == cs2) {
      return true;
    }
    if (cs1 == null || cs2 == null) {
  ...
  public static List<String> split(
      CharSequence str, CharSequence separator, boolean isTrim, boolean ignoreEmpty) {
   ...
   */
  public static List<String> split(
      CharSequence str, CharSequence separator, int limit, boolean isTrim, boolean ignoreEmpty) {
  ...
  public static boolean contains(
      final @Nullable CharSequence str, final @Nullable CharSequence searchStr) {
  ...
  public static boolean containsAny(
      final @Nullable CharSequence str, final @Nullable CharSequence... testStrs) {
  ...
  public static boolean startWith(
      final @Nullable CharSequence str,
      final @Nullable CharSequence prefix,
      boolean ignoreCase,
  ...
  public static boolean endWith(
      final @Nullable CharSequence str, final @Nullable CharSequence suffix) {
   ...
   */
  public static boolean endWith(
      final @Nullable CharSequence str, final @Nullable CharSequence suffix, boolean ignoreCase) {
  ...
  public static boolean endWith(
      final @Nullable CharSequence str,
      final @Nullable CharSequence suffix,
      boolean ignoreCase,
      boolean ignoreEquals) {
  ...
  public static String removePrefix(
      final @Nullable CharSequence str, final @Nullable CharSequence prefix) {
  ...
  public static String subBefore(
      final @Nullable CharSequence string,
      final @Nullable CharSequence separator,
