...
/**
 * 在 Spring 容器初始化时, 对数据源进行处理. <br>
 * 1. 针对 DataSource 进行处理，仅针对 sqlite：
 *
 * <ul>
 *   <li>提前创建 sqlite 数据文件所在目录.
 *   <li>检测到版本更新时(pom.xml -> project.version)自动备份原数据库.
 * </ul>
 *
 * <br>
 ...
 *
 * <ul>
 *   <li>SQLite 数据库使用 migration-sqlite 目录.
 *   <li>MySQL 数据库使用 migration-mysql 目录.
 * </ul>
 *
 * @author zhaojun
 */
...
public class DataSourceBeanPostProcessor implements BeanPostProcessor, PriorityOrdered {
   ...
   *
   * @param flywayProperties flyway 配置项
   */
