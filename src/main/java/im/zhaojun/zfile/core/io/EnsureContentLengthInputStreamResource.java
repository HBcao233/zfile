...
/**
 * 自定义 EnsureContentLengthInputStreamResource 可以保证必须实现 InputStream 的 contentLength 方法返回实际的长度. 此类相较于
 * {@link org.springframework.core.io.InputStreamResource} 仅实现了 contentLength 方法. <br>
 * <br>
