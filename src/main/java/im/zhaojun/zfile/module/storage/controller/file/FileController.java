...
public class FileController {
  ...
  @Resource private FileChain fileChain;
  ...
  public AjaxJson<List<StorageSourceResult>> storageList() {
    List<StorageSource> storageList =
        storageSourceService.findAllEnableOrderByOrderNum(ZFileAuthUtil.getCurrentUserId());
  ...
  @PostMapping("/files")
  public AjaxJson<FileInfoResult> list(@Valid @RequestBody FileListRequest fileListRequest)
      throws Exception {
    ...
    return AjaxJson.getSuccessData(
        new FileInfoResult(fileContext.getFileItemList(), fileContext.getPasswordPattern()));
  }
