...
@Slf4j
public class DogeCloudServiceImpl extends AbstractS3BaseFileService<DogeCloudParam>
  ...
  public void refreshAccessToken() {
    try {
      ...
      HttpResponse httpResponse =
          HttpUtil.createPost(apiDomain + apiPath)
              .body(jsonString)
      ...
      if (log.isDebugEnabled()) {
        log.debug(
            "{} 获取 S3 临时密钥完成. 响应状态码: {}, 响应体: {}", getStorageSimpleInfo(), responseStatus, body);
      }
      ...
      RefreshTokenInfoDTO tokenInfoDTO =
          RefreshTokenInfoDTO.success(s3AccessKey, s3SecretKey, s3SessionToken, expiredAt);
