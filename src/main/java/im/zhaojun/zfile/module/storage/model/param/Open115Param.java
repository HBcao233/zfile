...
public class Open115Param extends OptionalProxyTransferParam {
  ...
  @StorageParamItem(
      name = "AppID",
      description = "也可自行去 https://open.115.com 申请",
      defaultValue = "${zfile.open115.appId}",
      order = 1)
  ...
  @StorageParamItem(
      ...
      order = 3,
      defaultValue = "1",
      type = StorageParamTypeEnum.NUMBER,
      description =
          "表示每秒最多允许几个请求，<font color='#e6a23c'>建议最多为 1，过高可能会被风控。且 115 网盘严禁共享使用，多 IP"
              + " 下载也可能会导致风控/封号，详见：</font><a class='link' target='_blank'"
              + " href='https://www.yuque.com/115yun/open/vq62qwp8ia2efoli'>https://www.yuque.com/115yun/open/vq62qwp8ia2efoli</a>")
  private Double qps;
