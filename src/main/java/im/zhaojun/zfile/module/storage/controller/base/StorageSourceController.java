...
public class StorageSourceController {
  ...
  public AjaxJson<List<StorageSourceAdminResult>> storageList() {
    ...
    List<StorageSourceAdminResult> storageSourceAdminResults =
        storageSourceConvert.entityToAdminResultList(list);

    storageSourceAdminResults.forEach(
        storageSourceAdminResult -> {
          RefreshTokenCacheBO.RefreshTokenInfo refreshTokenInfo =
              RefreshTokenCacheBO.getRefreshTokenInfo(storageSourceAdminResult.getId());
  ...
  @PostMapping("/storage")
  @DemoDisable
  public AjaxJson<Integer> saveStorageItem(
      @RequestBody SaveStorageSourceRequest saveStorageSourceRequest) {
  ...
  public AjaxJson<Void> updateStorageSort(
      @RequestBody List<UpdateStorageSortRequest> updateStorageSortRequestList) {
  ...
  @Parameters({
    ...
    @Parameter(
        in = ParameterIn.PATH,
        name = "status",
        description = "存储源兼容模式状态",
        required = true,
        schema = @Schema(type = "boolean"))
  })
  @PostMapping("/storage/{storageId}/compatibility_readme/{status}")
  public AjaxJson<Void> changeCompatibilityReadme(
      @PathVariable Integer storageId, @PathVariable Boolean status) {
    StorageSource storageSource = storageSourceService.findById(storageId);
  ...
  @DemoDisable
  public AjaxJson<Integer> copyStorage(
      @RequestBody @Valid CopyStorageSourceRequest copyStorageSourceRequest) {
