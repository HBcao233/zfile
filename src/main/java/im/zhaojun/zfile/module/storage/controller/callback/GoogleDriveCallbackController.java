...
public class GoogleDriveCallbackController {
  ...
  @Resource private IOAuth2Service googleDriveOAuth2ServiceImpl;
  ...
  public String authorize(String clientId, String clientSecret, String redirectUri) {
    String authorizeUrl =
        googleDriveOAuth2ServiceImpl.generateAuthorizationUrl(clientId, clientSecret, redirectUri);
  ...
  public String googleDriveCallback(String code, String state, Model model) {
    ...
    OAuth2TokenDTO oAuth2TokenDTO =
        googleDriveOAuth2ServiceImpl.getTokenByCode(code, clientId, clientSecret, redirectUri);
