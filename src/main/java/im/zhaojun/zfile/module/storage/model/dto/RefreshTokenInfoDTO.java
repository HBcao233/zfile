...
public class RefreshTokenInfoDTO {
  ...
  public static RefreshTokenInfoDTO success(
      String accessToken, String refreshToken, String sessionToken, Integer expiredAt) {
  ...
  public static RefreshTokenInfoDTO success(
      String accessToken, String refreshToken, Integer expiredAt) {
