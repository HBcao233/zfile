...
public class MinIOParam extends S3BaseParam {
  ...
  @StorageParamItem(
      name = "服务地址",
      order = 30,
      description = "为 minio 的服务地址，非 web 访问地址，需包含协议，如 http://ip:9000")
  ...
  @StorageParamItem(
      description = "为 minio 的服务地址，非 web 访问地址，一般为 http://ip:9000",
      order = 65,
      onlyOverwrite = {StorageParamItemAnnoEnum.DESCRIPTION, StorageParamItemAnnoEnum.ORDER})
