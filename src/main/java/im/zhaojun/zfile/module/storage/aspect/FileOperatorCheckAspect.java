...
public class FileOperatorCheckAspect {
  ...
  public Object annotationCheck(
      ProceedingJoinPoint point, StoragePermissionCheck storagePermissionCheck) throws Throwable {
  ...
  public Object linkActionCheck(ProceedingJoinPoint point) throws Throwable {
    ...
    String storageKey =
        (arg instanceof BatchGenerateLinkRequest)
  ...
  @Around(
      "execution(public *"
          + " im.zhaojun.zfile.module.storage.service.base.AbstractBaseFileService.fileList(..)) ||"
          + " execution(public *"
          + " im.zhaojun.zfile.module.storage.service.base.AbstractBaseFileService.getFileItem(..))")
  ...
  @Around(
      "execution(public *"
          + " im.zhaojun.zfile.module.storage.service.base.AbstractBaseFileService.newFolder(..))")
  ...
  @Around(
      "execution(public *"
          + " im.zhaojun.zfile.module.storage.service.base.AbstractBaseFileService.delete*(..))")
  ...
  @Around(
      "execution(public *"
          + " im.zhaojun.zfile.module.storage.service.base.AbstractBaseFileService.getUploadUrl(..))"
          + " || execution(public *"
          + " im.zhaojun.zfile.module.storage.service.base.AbstractProxyTransferService.uploadFile(..))")
  ...
  @Around(
      "execution(public *"
          + " im.zhaojun.zfile.module.storage.service.base.AbstractBaseFileService.rename*(..))")
  public Object renameAround(ProceedingJoinPoint point) throws Throwable {
    ...
    clearOnlyOfficeCache(
        ...
        Objects.equals(point.getSignature().getName(), "renameFolder"));
  ...
  @Around(
      "execution(public *"
          + " im.zhaojun.zfile.module.storage.service.base.AbstractBaseFileService.move*(..))")
  public Object moveAround(ProceedingJoinPoint point) throws Throwable {
    ...
    clearOnlyOfficeCache(
        fullPath,
        targetService.storageId,
        Objects.equals(point.getSignature().getName(), "moveFolder"));
  ...
  @Around(
      "execution(public *"
          + " im.zhaojun.zfile.module.storage.service.base.AbstractBaseFileService.copy*(..))")
  ...
  private void clearOnlyOfficeCache(String fullPath, Integer storageId, boolean isFolder) {
    try {
      ...
      if (isFolder) {
        List<OnlyOfficeFile> caches =
            OnlyOfficeKeyCacheUtils.removeByFolder(new OnlyOfficeFile(storageKey, fullPath));
        if (CollectionUtils.isNotEmpty(caches)) {
          log.debug("删除/重命名文件夹时, 清除 OnlyOffice 缓存 {} 个", caches);
        }
      } else {
        OnlyOfficeFile onlyOfficeFile =
            OnlyOfficeKeyCacheUtils.removeByFile(new OnlyOfficeFile(storageKey, fullPath));
