...
public class S3Param extends S3BaseParam {
  ...
  @StorageParamItem(
      ...
      options = {
        @StorageParamSelectOption(value = "path-style", label = "路径风格"),
        @StorageParamSelectOption(value = "bucket-virtual-hosting", label = "虚拟主机风格")
      },
      linkName = "查看 S3 API 说明文档",
      link =
          "https://docs.aws.amazon.com/zh_cn/AmazonS3/latest/userguide/VirtualHosting.html#path-style-access",
