...
public interface StorageSourceConvert {
   ...
   *
   * @param storageSource StorageSource 实体
  ...
  StorageSourceConfigResult entityToConfigResult(
      StorageSource storageSource, ReadmeConfig readmeConfig);
  ...
  StorageSourceDTO entityToDTO(
      StorageSource storageSource, StorageSourceAllParamDTO storageSourceAllParam);

  /**
   * 将 SaveStorageSourceRequest 转换为 StorageSource
   *
   * @param saveStorageSourceRequest SaveStorageSourceRequest 实体
