...
public class AliyunServiceImpl extends AbstractS3BaseFileService<AliyunParam> {
  ...
  public void init() {
    ...
    StaticCredentialsProvider credentialsProvider =
        StaticCredentialsProvider.create(
            AwsBasicCredentials.create(param.getAccessKey(), param.getSecretKey()));
  ...
  public String getDownloadUrl(String pathAndName) {
    ...
    String defaultUrl =
        signer.generatePresignedUrl(bucketName, fullPath, HttpMethod.GET, expiration);
  ...
  static class Signer {
    ...
    private String generatePresignedUrl(
        String bucketName, String key, HttpMethod method, Date expiration) {
