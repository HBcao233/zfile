 ...
 * 115 文件和路径 ID 缓存服务.
 *
 * <p>每个存储源实例持有一个此类的实例，用于隔离不同存储源的缓存。
 *
 * @author zhaojun
 */
@Slf4j
public class Open115IdCacheService {
  ...
  /** 路径 ID 缓存 */
  private final Map<String, String> pathIdMap =
   ...
   * 发送带认证的 GET 请求的函数.
   *
   * <p>参数1: 请求 URL 参数2: 请求参数 返回值: 响应的 JSON 对象
   */
  private final BiFunction<String, Map<String, Object>, JSONObject> sendGetRequestWithAuth;

  public Open115IdCacheService(
      BiFunction<String, Map<String, Object>, JSONObject> sendGetRequestWithAuth) {
