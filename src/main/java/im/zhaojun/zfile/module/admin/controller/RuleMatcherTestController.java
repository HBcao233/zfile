...
public class RuleMatcherTestController {
   ...
   *
   * @param testRuleMatcherRequest 测试规则匹配请求
   * @return 匹配成功的第一个表达式
   */
  @PostMapping("/rule-test")
  public AjaxJson<String> testRule(
      @RequestBody @Valid TestRuleMatcherRequest testRuleMatcherRequest) {
    ...
    IRuleMatcher ipRuleMatcher =
        RuleMatcherFactory.getRuleMatcher(testRuleMatcherRequest.getRuleType());
