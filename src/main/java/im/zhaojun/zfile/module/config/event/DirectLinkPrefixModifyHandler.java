...
public class DirectLinkPrefixModifyHandler implements ISystemConfigModifyHandler {
  ...
  public void modify(SystemConfig originalSystemConfig, SystemConfig newSystemConfig) {
    ...
    RequestMappingInfo requestMappingInfo =
        RequestMappingInfo.paths(newValue + DirectLinkController.DIRECT_LINK_SUFFIX_PATH).build();
    dynamicDirectLinkPrefixService.updateRegisterMappingHandler(
        SystemConfig.DIRECT_LINK_PREFIX_NAME, requestMappingInfo);
