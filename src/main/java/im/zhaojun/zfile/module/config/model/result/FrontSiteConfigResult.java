...
public class FrontSiteConfigResult {
  ...
  @Schema(
      title = "直链地址前缀",
      example = "true",
      description = "直链地址前缀, 如 http(s)://ip:port/${直链前缀}/path/filename")
  ...
  @Schema(
      title = "列表尺寸",
      description = "large:大,default:中,small:小",
      example = "default",
      requiredMode = Schema.RequiredMode.REQUIRED)
  private String tableSize;

  @Schema(
      title = "是否显示生成直链功能（含直链和路径短链）",
      example = "true",
      requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  @Schema(
      title = "短链过期时间设置",
      example =
          "[{value: 1, unit: \"day\"}, {value: 1, unit: \"week\"}, {value: 1, unit: \"month\"},"
              + " {value: 1, unit: \"year\"}]")
