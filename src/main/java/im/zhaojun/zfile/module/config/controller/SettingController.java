...
public class SettingController {
  ...
  @Resource private ZFileProperties zFileProperties;
  ...
  public AjaxJson<SystemConfigDTO> getConfig() {
    ...
    if (zFileProperties != null && zFileProperties.isDemoSite()) {
      SystemConfigDTO copy =
          JSON.parseObject(JSON.toJSONString(systemConfigDTO), SystemConfigDTO.class);
  ...
  @DemoDisable
  public AjaxJson<Void> updateSiteSetting(
      @Valid @RequestBody UpdateSiteSettingRequest settingRequest) {
    if (StrUtil.length(settingRequest.getAuthCode()) > 36
        && StrUtil.length(settingRequest.getAuthCode()) < 100) {
  ...
  @DemoDisable
  public AjaxJson<Void> updateViewSetting(
      @Valid @RequestBody UpdateViewSettingRequest settingRequest) {
    SystemConfigDTO systemConfigDTO = new SystemConfigDTO();
    BeanUtils.copyProperties(settingRequest, systemConfigDTO);
    systemConfigService.updateSystemConfig(systemConfigDTO);
    return AjaxJson.getSuccess();
  ...
  @DemoDisable
  public AjaxJson<Void> updateSecuritySetting(
      @Valid @RequestBody UpdateSecuritySettingRequest settingRequest) {
    SystemConfigDTO systemConfigDTO = new SystemConfigDTO();
    BeanUtils.copyProperties(settingRequest, systemConfigDTO);
  ...
  @DemoDisable
  public AjaxJson<Void> updateLinkSetting(
      @Valid @RequestBody UpdateLinkSettingRequest settingRequest) {
    SystemConfigDTO systemConfigDTO = new SystemConfigDTO();
    BeanUtils.copyProperties(settingRequest, systemConfigDTO);
    systemConfigService.updateSystemConfig(systemConfigDTO);
    return AjaxJson.getSuccess();
  ...
  @DemoDisable
  public AjaxJson<Void> updateSecuritySetting(
      @Valid @RequestBody UpdateAccessSettingRequest updateAccessSettingRequest) {
    SystemConfigDTO systemConfigDTO = new SystemConfigDTO();
