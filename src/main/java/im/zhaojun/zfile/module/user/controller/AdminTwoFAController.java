...
public class AdminTwoFAController {
  ...
  @Resource private TwoFactorAuthenticatorVerifyService twoFactorAuthenticatorVerifyService;
  ...
  public AjaxJson<LoginTwoFactorAuthenticatorResult> setupDevice() throws QrGenerationException {
    LoginTwoFactorAuthenticatorResult loginTwoFactorAuthenticatorResult =
  ...
  @DemoDisable
  public AjaxJson<Void> deviceVerify(
      @Valid @RequestBody
