...
public class DownloadLogService {
  ...
  @Resource private DownloadLogMapper downloadLogMapper;
  ...
  public void onStorageSourceDelete(StorageSourceDeleteEvent storageSourceDeleteEvent) {
    ...
    int updateRows =
        ((DownloadLogService) AopContext.currentProxy()).deleteByStorageKey(storageKey);
    if (log.isDebugEnabled()) {
      log.debug(
          "删除存储源 [id {}, key: {}, name: {}, type: {}] 时，关联删除存储源直/短链下载日志 {} 条",
