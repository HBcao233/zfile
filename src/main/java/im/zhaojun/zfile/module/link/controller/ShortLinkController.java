...
public class ShortLinkController {
  ...
  public AjaxJson<List<BatchGenerateLinkResponse>> generatorShortLink(
    ...
    for (String path : batchGenerateLinkRequest.getPaths()) {
      // 拼接全路径地址.
      String currentUserBasePath =
          StorageSourceContext.getByStorageId(storageId).getCurrentUserBasePath();
      ...
      String shortUrl =
          StringUtils.removeDuplicateSlashes(domain + "/s/" + shortLink.getShortKey());
