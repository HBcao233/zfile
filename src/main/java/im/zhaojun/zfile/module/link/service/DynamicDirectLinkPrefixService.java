...
public class DynamicDirectLinkPrefixService {
  ...
  public static final Map<String, DynamicRegisterMappingHandlerDTO> REGISTER_MAPPING =
      new ConcurrentHashMap<>();

  public void registerMappingHandlerMapping(
      String key,
      RequestMappingInfo requestMappingInfo,
      Object controllerObj,
      Method directLinkMethod) {
    requestMappingHandlerMapping.registerMapping(
        requestMappingInfo, controllerObj, directLinkMethod);
    REGISTER_MAPPING.put(
        key,
        new DynamicRegisterMappingHandlerDTO(requestMappingInfo, controllerObj, directLinkMethod));
  }
    ...
    synchronized (key.intern()) {
      ...
      if (dynamicRegisterMappingHandlerDTO != null) {
        requestMappingHandlerMapping.unregisterMapping(
            dynamicRegisterMappingHandlerDTO.getRequestMappingInfo());
        requestMappingHandlerMapping.registerMapping(
            requestMappingInfo,
            dynamicRegisterMappingHandlerDTO.getObject(),
            dynamicRegisterMappingHandlerDTO.getMethod());
        REGISTER_MAPPING.put(
            key,
            new DynamicRegisterMappingHandlerDTO(
                requestMappingInfo,
                dynamicRegisterMappingHandlerDTO.getObject(),
                dynamicRegisterMappingHandlerDTO.getMethod()));
      }
